...
title = MarketBank POS

# (str) Package name
package.name = marketbank

# (str) Package domain (needed for android/ios packaging)
package.domain = org.marketbank
...
requirements = python3,kivy,requests,urllib3,certifi,openssl,chardet,idna
...
# (list) Java classes to add to the additional dex
#android.add_activites = com.example.ExampleActivity

# (str) python-for-android whitelist
#p4a.whitelist =

# (str) python-for-android branch to clone, if not master, useful to try
# a fix from another GitHub user, or the trunk
#p4a.branch = master

# (str) python-for-android repository to clone
#p4a.source_dir =
...
#    Let's take [app] / requirements. Instead of defining the option
#    in the [app] section, you can define it here:
#
#    [app:requirements]
#    python3
#    kivy
#    android
#
#    Keep in mind that if you define separately the list here, the previous
#    declaration in the app section will be ignored.
